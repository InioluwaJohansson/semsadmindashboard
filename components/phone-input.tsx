...
// Comprehensive list of country codes with flags - fixing the Brazil flag which had an issue
const countryCodes = [
  ...
  { code: "+55", country: "Brazil", flag: "🇧🇷" }, // Fixed Brazil flag
...
export function PhoneInput({ value, onChange, countryCode, onCountryCodeChange, className, error }: PhoneInputProps) {
  // Find the selected country to display the flag
  ...
  return (
    <div className="flex space-x-2">
      <Select value={countryCode} onValueChange={onCountryCodeChange}>
        ...
        <SelectContent className="max-h-[200px]">
          {countryCodes.map((country) => (
            <SelectItem key={country.code + country.country} value={country.code} className="flex items-center">
      ...
      <Input
        ...
        className={cn("flex-1", className, error ? "border-red-500" : "")}
